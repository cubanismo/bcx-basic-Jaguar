...
sample0:	dc.l	sfx_points						; start of sample - just the external label to U235 here
			dc.l	sfx_points_end					; end of sample - the external label to U235 with an added _end suffix
...
sample1:	dc.l	sfx_tombe						; start of sample - just the external label to U235 here
			dc.l	sfx_tombe_end					; end of sample - the external label to U235 with an added _end suffix
			dc.l	0								; loop - start position
			dc.l	0								; loop - end position
			dc.w	0								; <NULL>
			dc.b	0								; fine tune
...
sample2:	dc.l	sfx_touche						; start of sample - just the external label to U235 here
...
sample5:	dc.l	sfx_sorcier						; start of sample - just the external label to U235 here
			dc.l	sfx_sorcier_end					; end of sample - the external label to U235 with an added _end suffix
			dc.l	0								; loop - start position
			dc.l	0								; loop - end position
			dc.w	0								; <NULL>
			dc.b	0								; fine tune
...
sample6:	dc.l	sfx_theme						; start of sample - just the external label to U235 here
