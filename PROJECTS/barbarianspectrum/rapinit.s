...
; sprite 0 - decors ZX  ************
	...
	dc.l	decorsZX						; sprite_gfxbase				; start of bitmap data
...
; sprite 2 - spriteA  ************
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	-74,0							; sprite_x						; 16.16 x value to position at
	dc.w	136,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
...
; sprite 5 - gnome
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	-42,0							; sprite_x						; 16.16 x value to position at
	dc.w	184,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
...
; sprite 6 - ombre tetes
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	-26,0							; sprite_x						; 16.16 x value to position at
	dc.w	184,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
...
; sprite 7 - tetes volantes
	...
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	16/2							; sprite_gwidth					; GFX width (of data)
; sprite  8 - arbre gauche
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	3,0								; sprite_x						; 16.16 x value to position at
	dc.w	152,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
...
; sprite  9 - arbre droit
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	291,0							; sprite_x						; 16.16 x value to position at
	dc.w	152,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	dc.l	64								; sprite_width					; width of sprite (in pixels)
...
; sprite  11 - serpent gauche
	...
	dc.l	32/2							; sprite_hbox					; width of collision box
	dc.l	5/2								; sprite_vbox					; height of collision box
	dc.l	SPRserpentG						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_opaque						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*32/2							; sprite_framesz				; size per frame in bytes of sprite data
...
; sprite  12 - serpent droit
	...
	dc.l	32/2							; sprite_hbox					; width of collision box
	dc.l	5/2								; sprite_vbox					; height of collision box
	dc.l	SPRserpentD						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_opaque						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	32*32/2							; sprite_framesz				; size per frame in bytes of sprite data
...
; sprite  14 - cache marianna *****
	...
	dc.l	2								; sprite_damage					; Hitpoints deducted from target
	dc.l	32/2							; sprite_gwidth					; GFX width (of data)
; sprite 15 - couleurs defilantes du menu
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	-100,0							; sprite_x						; 16.16 x value to position at
	dc.w	300,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	...
	dc.l	32/2							; sprite_hbox					; width of collision box
	dc.l	5/2								; sprite_vbox					; height of collision box
	dc.l	SPRcouleurs						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_opaque						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	128*8/2							; sprite_framesz				; size per frame in bytes of sprite data
...
; sprite  16 - decor menu  ************
	...
	dc.l	32/2							; sprite_hbox					; width of collision box
	dc.l	5/2								; sprite_vbox					; height of collision box
	dc.l	menuZX							; sprite_gfxbase				; start of bitmap data
	dc.l	8								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
	dc.l	336*200							; sprite_framesz				; size per frame in bytes of sprite data
...
; sprite 17 - fleche du menu
	dc.l	1								; (REPEAT COUNTER) 				; Create this many objects of this type (or 1 for a single object)
	dc.l	is_active						; sprite_active					; sprite active flag
	dc.w	-58,0							; sprite_x						; 16.16 x value to position at
	dc.w	50,0							; sprite_y						; 16.16 y value to position at
	dc.w	0,0								; sprite_xadd					; 16.16 x addition for sprite movement
	dc.w	0,0								; sprite_yadd					; 16.16 y addition for sprite movement
	...
	dc.l	32/2							; sprite_hbox					; width of collision box
	dc.l	5/2								; sprite_vbox					; height of collision box
	dc.l	SPRfleche						; sprite_gfxbase				; start of bitmap data
	dc.l	4								; (BIT DEPTH)					; bitmap depth (1/2/4/8/16/24)
	dc.l	is_RGB							; (CRY/RGB)						; bitmap GFX type
	dc.l	is_trans						; (TRANSPARENCY)				; bitmap TRANS flag
