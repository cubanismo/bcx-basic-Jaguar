...
'_______a remake of APPLEII version_____
...
loadclut(strptr(decorsAPPLEII_clut),0,16) ' palette decors
...
' demo
partie = 1: decorS = 1: IA = 4: sorcier = 0: marianna = 0: demo = 1

' 1 joueur
'partie = 1: decorS = 3: IA = 0: sorcier = 0: marianna = 0: demo = 0
'partie = 1: decorS = 4: IA = 7: sorcier = 0: marianna = 0: demo = 0 ' sorcier

' mode vs
'partie = 2: decorS = 2: IA = 0: sorcier = 0: marianna = 0: chronometre = 60: demo = 0
...
DO
    ...
    IF GOTOU = 101 THEN
		...
		if temps > 400 THEN 
			temps = 0: GOTOU = 100	
			' choix du titre
			rsetobj(NoSPRtitre,R_sprite_gfxbase,(int)strptr(decorsAPPLEII)+ (32000) )' choix de la frame dans la planche 32000 = 320*(200*4)/8
		END IF
	END IF
    ...
    IF GOTOU = 32 THEN
			...
			' choix du decor
			rsetobj(NoSPRdecor,R_sprite_gfxbase,(int)strptr(decorsAPPLEII)+ (32000 * (decorS+1) ) ) ' choix de la frame dans la planche 32000 = 320*(200*4)/8
		...
		rlist[NoSPRarbreG].y=150<<16
			
		'  affichage de l'arbre droit
		rsetobj(NoSPRarbreD,R_sprite_gfxbase,(int)strptr(arbresDROIT)+ 2048* (decorS-1) )			
		rlist[NoSPRarbreD].y=150<<16		

		
		' re-afficher les sprites
		rlist[NoSPRspriteA].y=120+13<<16	'joueurA
		rlist[NoSPRspriteB].y=120+13<<16	'joueurB		
		...
		RLOCATE 276,20: RPRINT "()()()"
		 ...
		 rlist[NoSPRmode].x=155<<16
		 rlist[NoSPRmode].y=216+8<<16
		IF partie = 1 AND demo = 0 THEN rsetobj(NoSPRmode,R_sprite_gfxbase,(int)strptr(SPRmode)+ (192 * 1 ) )' choix de la frame dans la planche 192 = 48*(8*4)/8
        IF partie = 2 THEN rsetobj(NoSPRmode,R_sprite_gfxbase,(int)strptr(SPRmode)+ (192 * 2 ) )
		IF demo = 1 THEN rsetobj(NoSPRmode,R_sprite_gfxbase,(int)strptr(SPRmode)+ (192 * 0 ) ) 
...
sonrigole = 0
		...
		loadclut(strptr(paletteB0_clut),7,16) ' couleur IA
    ...
    IF GOTOU = 0 AND jeu = 2 THEN GOTOU = 26 ' ex23

    IF GOTOU = 0 AND joueurA = 777 THEN GOTOU = 26 ' /* ex25 */

    IF GOTOU = 0 AND marianna = 1 THEN


			jeu = 2 

            Aoccupe = 1
            joueurA = 777: spriteA = 57: ' marianna

            Boccupe = 1
            joueurB = 777: marianna = 1: spriteB = 42 ' joueurA=fini

            xA = 13: xB = 20

            IF GOTOU = 0 THEN GOTOU = 31 ' ex23 ' degatsA */
	END IF
    ...
    IF GOTOU = 0 AND sorcier = 1 THEN
           IF xA >= 28 THEN
              ...
              'Boccupe = 1
              'joueurB = 64: xB = 39
			  marianna = 1: sorcier = 2 ' sorcier = mort */

              GOTOU = 20 ' gestionB */
          END IF
          IF GOTOU = 0 THEN GOTOU = 23 ' degats */
...
'coco
    ...
    IF GOTOU = 0 AND joueurA = 6191 THEN 'tombe1
        ...
        IF GOTOU = 0 AND temps > reftemps + 2 THEN
            ...
            IF joueurB = 617 AND musiqueLOOP = 0 THEN SNDZEROPLAY(1, strptr(sfx_tete), (strptr(sfx_tete_end)-strptr(sfx_tete)+3) and 0xfffffffc, 46168/9233, Zero_Audio_8bit_muLaw|0)
            GOTOU = 1
        END IF
    ...
    IF GOTOU = 0 AND joueurA = 9191 THEN 'tombe1r
        ...
        IF GOTOU = 0 AND temps > reftemps + 2 THEN
            ...
            IF joueurB = 917 AND musiqueLOOP = 0 THEN SNDZEROPLAY(1, strptr(sfx_tete), (strptr(sfx_tete_end)-strptr(sfx_tete)+3) and 0xfffffffc, 46168/9233, Zero_Audio_8bit_muLaw|0)
            GOTOU = 1
        END IF
        IF GOTOU = 0 AND temps >= reftemps THEN spriteA = 45: GOTOU = 1
    END IF
...
'coco
    ...
    IF GOTOU = 0 AND joueurB = 64 THEN 'debout
        spriteB = 0
        'IF marianna=1 then spriteB = 57 ' marianna
        decapiteB = 1
        sangB = 0
        xAttB = xB + 4: yAttB = 14:
    ...
    IF GOTOU = 0 AND joueurB = 6191 THEN 'tombe1
        ...
        IF GOTOU = 0 AND temps > reftempsB + 2 THEN
            ...
            IF joueurA = 617 AND musiqueLOOP = 0 THEN SNDZEROPLAY(1, strptr(sfx_tete), (strptr(sfx_tete_end)-strptr(sfx_tete)+3) and 0xfffffffc, 46168/9233, Zero_Audio_8bit_muLaw|0)
            GOTOU = 2
        END IF
    ...
    IF GOTOU = 0 AND joueurB = 9191 THEN 'tombe1R
        ...
        IF GOTOU = 0 AND temps > reftempsB + 2 THEN
            ...
            IF joueurA = 917 AND musiqueLOOP = 0 THEN SNDZEROPLAY(1, strptr(sfx_tete), (strptr(sfx_tete_end)-strptr(sfx_tete)+3) and 0xfffffffc, 46168/9233, Zero_Audio_8bit_muLaw|0)
            GOTOU = 2
        END IF
        IF GOTOU = 0 AND temps >= reftempsB THEN spriteB = 45: GOTOU = 2
    END IF
        ...
        IF GOTOU = 0 THEN
            IF joueurA = 65 OR joueurA = 95 THEN
                ...
                IF GOTOU = 0 AND temps > reftemps + 44 THEN
                    IF xSPRt < 273 THEN
						'_SNDPLAY tete
						IF musiqueLOOP = 0 THEN SNDZEROPLAY(1, strptr(sfx_tete), (strptr(sfx_tete_end)-strptr(sfx_tete)+3) and 0xfffffffc, 46168/9233, Zero_Audio_8bit_muLaw|0)					
					END IF 
    ...
    IF GOTOU = 0 AND sorcier = 1 THEN
        ...
        ' cache Drax
				rlist[NoSPRcache1].x=124+6<<16
				rlist[NoSPRcache1].y=96+12<<16
    END IF
	
	
        'cache marianna
        IF GOTOU = 0 AND marianna = 1 THEN
				rlist[NoSPRcache2].x=203-8<<16
				rlist[NoSPRcache2].y=96+12<<16
        END IF
    ...
    IF GOTOU = 0 THEN
        ...
        IF joueurA = 610 OR joueurA = 910 OR joueurA = 65 OR joueurA = 95 THEN
			...
			rlist[NoSPRspriteAmort].y=120+13<<16
...
'END IF
              ...
              '  affichage des tetes */
                  ...
                  xSPRt = (xSPRt + 1) * 8 '  laisser en x8 pour le football ,) */
                   ...
                   positionX = xSPRt : positionY = ySPRt + 24
					...
					rlist[NoSPRtetes].y=positionY+13<<16


                   ' ombre de la tete
                   positionX = xSPRt: positionY = 182
				   rlist[NoSPRombre].x=positionX<<16
				   rlist[NoSPRombre].y=positionY+13<<16
    ...
    IF GOTOU = 0 AND gnome = 1 THEN 
		...
		rlist[NoSPRgnome].y=168+13<<16	'gnome
     ...
     ' boulefeu
      if  GOTOU = 9 THEN GOTOU = 0
        ...
        if  jeu = 1 AND sorcier = 1 AND xAttB < xB + 2 THEN 
          ...
          positionX =  ( xAttB + 2 ) * 8: positionY =  ( yAttB +2 ) * 8 +13

          if  xAttB = 26 OR xAttB = 17 OR xAttB = 9 THEN 
...
'RLOCATE 128,12: RPRINT "BETA.105"
'RLOCATE 100,16: RPRINT "   ":RPRINTINT xA 
'RLOCATE 160,16: RPRINT "   ":RPRINTINT yTA

' *** DEBUG *****	
if GOTOU = 0 THEN
	'RLOCATE 8,192: RPRINT "      ": RPRINTINT xA
	'RLOCATE 8,200: RPRINT "      ": RPRINTINT xB
	'RLOCATE 8,208: RPRINT "      ": RPRINTINT distance
END IF	
